...
[R-Ladies](http://rladies.org/) is a global organization to promote diversity in the R community. One of the ways of promoting diversity is by increasing the visibility of women and other underrepresented genders* in tech, especially those who are R users, or developers.

* (cis/trans women, trans men, non-binary, genderqueer, agender, or other). 
...
* The majority of the tweets (with location services on) come from Uruguay`r emo::ji("Uruguay")` (but there are a lot of missing locations)
